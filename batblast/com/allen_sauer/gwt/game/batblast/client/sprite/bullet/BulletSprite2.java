...
public class BulletSprite2 extends Sprite {
  static int delay;
  private static final BoundingBoxInfo BOUNDING_BOX_INFO;
  private static final int FRAME_ANIMATE_INTERVAL = 50000;
  private static final int FRAME_HEIGHT = BatBlastClientBundle.INSTANCE.iceCube2().getHeight() * 0 + 32;
  private static final int FRAME_WIDTH = BatBlastClientBundle.INSTANCE.iceCube2().getWidth() * 0 + 32;
  private static final int FRAMES_HORIZONTAL = 1;
  private static final int FRAMES_VERTICAL = 1;

  private static final String SPRITE_URL = BatBlastClientBundle.INSTANCE.iceCube2().getURL();
  ...
  public BulletSprite2(Game game, PlayerSprite playerSprite) {
