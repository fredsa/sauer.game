...
public class JokerSprite extends Sprite {
  ...
  private static final int FRAME_HEIGHT = BatBlastClientBundle.INSTANCE.joker().getHeight() / 10;
  private static final int FRAME_WIDTH = BatBlastClientBundle.INSTANCE.joker().getWidth() / 10;
  private static final int FRAMES_HORIZONTAL = 1;
  private static final int FRAMES_VERTICAL = 1;
  private static final String SPRITE_URL = BatBlastClientBundle.INSTANCE.joker().getURL();
  static {
