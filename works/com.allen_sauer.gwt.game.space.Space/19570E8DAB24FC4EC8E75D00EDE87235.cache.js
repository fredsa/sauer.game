...
function $setTabIndex(this$static, index){
  $setTabIndex_0(impl_1, this$static.getElement(), index);
}
...
function debug(text){
  ...
  if (debugTextArea === null) {
    ...
    $setHorizontalAlignment(debugTable.cellFormatter, 0, 0, ($clinit_67() , ALIGN_CENTER));
    $run(timer_0);
...
function round_long(x){
  if (x > ($clinit_117() , MAX_VALUE_0))
    return $clinit_117() , MAX_VALUE_0;
  if (x < ($clinit_117() , MIN_VALUE_0))
    return $clinit_117() , MIN_VALUE_0;
  return x >= 0?Math.floor(x):Math.ceil(x);
}
...
function $init_1(this$static){
  ...
  $wnd.__dispatchEvent = function(){
    ...
    if (this.__listener)
      dispatchEvent($wnd.event, this, this.__listener);
  }
  ;
...
function $add_1(this$static, w, container){
  return $insert(this$static, w, container, this$static.children_0.size);
}
...
function $insert(this$static, w, container, beforeIndex){
  var idx;
  if (beforeIndex < 0 || beforeIndex > this$static.children_0.size) {
  ...
  $insert_0(this$static.children_0, w, beforeIndex);
  return beforeIndex;
}

function $remove(this$static, w){
  if (!$contains(this$static.children_0, w)) {
    return false;
  }
...
function onWindowClosed_0(){
  var gwt, it;
  for (it = $iterator_2($values(($clinit_85() , rootPanels))); $hasNext_2(it);) {
...
function $setTabIndex_0(this$static, elem, index){
  elem.tabIndex = index;
}
